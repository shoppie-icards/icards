...
<div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li <?php if($className == 'InitializeCardController') { echo "class='current'"; } ?>>
                ...
                <li <?php if($className == 'MessagesController') { echo "class='current'"; } ?>>
                ...
                <li <?php if($className == 'IncentivesController') { echo "class='current'"; } ?>>
                ...
                <li <?php if($className == 'FeedbackController') { echo "class='current'"; } ?>>
                ...
                <li <?php if($className == 'AccountManageController') { echo "class='current'"; } ?>>
                ...
                <li <?php if($className == 'AnalyticsController') { echo "class='current'"; } ?>>
                    <a href="{{ URL('merchant/analytics') }}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-area-chart fa-stack-1x "></i></span> Thống kê</a>
                </li>
